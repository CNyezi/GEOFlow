    ...
    <div class="tt-shell">
        <div class="tt-header-row">
            ...
            <nav class="tt-topnav" aria-label="Primary">
                <a href="{{ route('site.home') }}" data-nav-item="home" class="{{ $isHome ? 'is-active' : '' }}">Home</a>
        ...
        <div id="ttMobileNav" class="hidden pb-4">
            <div class="tt-channel-rail !sticky !top-auto">
                <a href="{{ route('site.home') }}" data-nav-item="home" class="tt-channel {{ $isHome ? 'is-active' : '' }}">Home</a>
